...
export const getInTransitLetters = async (req, res) => {
  try {
    ...
    const formattedLetters = inTransitLetters.map(letter => {
      ...
      return {
        ...
        letter: {
          ...
          content: letter.letter.content.length > 150 
            ? letter.letter.content.substring(0, 150) + '...'
...
export const processReadyLetters = async (req, res) => {
  try {
...
export const deliverLetter = async (req, res) => {
  try {
